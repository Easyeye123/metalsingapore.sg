...
segs=[
 ...
 ("photo",P("3446f837-IMG_4937.jpeg"),"Railings around live PTU & STS containers","Fitted inside a congested, operational M&E plant","On Site"),
 ("photo",P("23bf4178-IMG_4967.png"),"Fabricated and installed by our team","On live containers, with full fall protection","Installation"),
 ("photo",P("89b08535-IMG_4038.jpeg"),"The challenge — no welding on the container","Every connection had to be mechanical","The Challenge"),
 ("draw", D("bp2.png"),"Bolted to the existing steel channel","6 nos GR8.8 M16 anchor bolts · SS304 fixings","Drawing"),
 ("photo",P("92f5a323-IMG_4032.jpeg"),"SS304 handrails — PE approved","Engineered to Singapore Standards","Fabrication"),
 ("photo",P("15457fb2-IMG_4936.jpeg"),"SS304 handrails — PE approved","Engineered to Singapore Standards","Engineering"),
 ("photo",P("c1464a96-IMG_4968.png"),"Custom-fabricated in our workshop","Stainless frames, gratings & curved handrails","Fabrication"),
 ("photo",P("ae4c32b4-IMG_4969.png"),"Custom-fabricated in our workshop","Jig-welded frames, then fitted on site","Workshop"),
 ("photo",P("234dffd3-IMG_4944.jpeg"),"Securing the cat-ladder for access","Protected by a fall-arrestor system","Fall Protection"),
 ("photo",P("4764be1f-IMG_4935.jpeg"),"Securing the cat-ladder for access","Protected by a fall-arrestor system","Fall Protection"),
 ("draw", D("frame_srl.png"),"Self-retracting lifeline on a steel frame","HARU HE-10 SRL · EN360 certified","Drawing"),
 ("draw", D("ladconn.png"),"Fixed to the existing structure — no welds","SS304 25×50×3 ladder · full strength","Drawing"),
 ("photo",P("b8dcfe20-IMG_4934.jpeg"),"Fixed to the existing structure — no welds","SS304 25×50×3 ladder · full strength","On Site"),
 ("photo",P("0078b011-IMG_4949.jpeg"),"The result — safe, PE-certified access","Handrails, cat-ladder & fall-arrestor, installed","Completed"),
 ("photo",P("02072201-IMG_4948.jpeg"),"Engineered. Bolted. Certified safe.","Ezzogenics · metalsingapore.sg · metalglassworksingapore.com","Ezzogenics"),
]
